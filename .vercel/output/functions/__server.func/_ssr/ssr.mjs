...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-0YTp2qfV.mjs");
...
var manifest = {
	"660d2259743bff2cfcb01f2c7c91b27e572662697a890056662344f43b58751d": {
		...
		importer: () => import("./workspace-CuOymT79.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-L3Ql1fD6.mjs").then((n) => n.t),
